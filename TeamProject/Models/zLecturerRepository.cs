...
{ 
    public class zLecturerRepository : IzLecturerRepository
    {
        ...
        {
            return context.zLecturers.Find(id);
        }
        ...
        public void InsertOrUpdate(zLecturer zlecturer)
        {
            if (zlecturer.LecturerId == default(int)) 
            {
                ...
                context.zLecturers.Add(zlecturer);
            } else 
            {
                // Existing entity
        ...
        {
            var zlecturer = context.zLecturers.Find(id);
            context.zLecturers.Remove(zlecturer);
        }
